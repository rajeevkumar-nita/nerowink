...
const CareersatNerowink = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-blue-50 text-gray-800 relative">
      <div className="sticky top-0 z-20 bg-white border-b shadow-sm px-4 py-4">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between">
          <h1 className="text-2xl font-bold text-gray-800 mb-3 md:mb-0">Careers at NeroWink</h1>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12 space-y-20">
        ...
        <div id="open-positions" className="scroll-mt-24">
          <h2 className="text-2xl font-semibold mb-4 text-blue-700">Open Positions</h2>
          <p className="text-gray-700 leading-relaxed">
            We’re hiring across roles including Frontend & Backend Engineering, UI/UX Design, Marketing, and Product Management. If you're a self-starter who loves solving real-world problems, we’d love to have you on board.
          </p>
          ...
          {/* Testimonials */}
          <div className="mt-10">
            <h2 className="text-2xl font-semibold mb-6 text-center text-blue-700">What Our Team Says</h2>
            <Carousel
              autoPlay
              infiniteLoop
              showThumbs={false}
        ...
        <div id="benefits" className="scroll-mt-24">
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            At NeroWink, we believe that people are our most valuable asset. Our work culture is built on trust, flexibility, and well-being. We offer benefits designed to support your personal and professional journey.
          </p>
        ...
        <div id="employee-value-proposition-&-culture" className="scroll-mt-24">
          <h2 className="text-2xl font-semibold mb-4 text-blue-700">Employee Value Proposition & Culture</h2>
            <ul className="list-none space-y-4 text-gray-700 leading-relaxed text-base pl-2">
    <li>💼 At NeroWink, we’re building more than products — we’re building a workplace where every individual feels seen, heard, and valued.</li>
    <li>👩‍💻 Whether you're a coder, designer, or strategist — you'll grow through mentoring, learning, and real impact.</li>
    <li>🚀 Our work is purpose-driven. We design, build, and launch products that solve real problems.</li>
    <li>🧘 We promote healthy flexibility — from remote-friendly setups to mental wellness breaks.</li>
    <li>🤝 We believe in transparency and integrity. Growth is a shared mission — and we lead it together, honestly and ethically.</li>
  </ul>
        </div>

        {/* Professional Development */}
        <div id="professional-development" className="scroll-mt-24">
          <h2 className="text-2xl font-semibold mb-4 text-blue-700">Professional Development</h2>
          <p className="text-gray-700 leading-relaxed mb-6">
            We’re invested in your journey. Whether you're just starting or aiming for leadership, NeroWink offers tools, mentoring, and opportunities that make career growth inevitable.
          </p>

          <div className="grid md:grid-cols-3 gap-4 mb-6">
            {[{ skill: "Tech Skills", value: "90%" }, { skill: "Leadership", value: "80%" }, { skill: "Communication", value: "85%" }].map(({ skill, value }, idx) => (
              <div key={idx}>
                <span className="text-sm font-medium text-gray-600">{skill}</span>
                <div className="w-full bg-gray-200 rounded-full h-3 mt-1">
                  <div className="bg-blue-600 h-3 rounded-full transition-all" style={{ width: value }}></div>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-8">
            {[{ title: "Mentorship", desc: "1-on-1 guidance with senior professionals to boost career clarity and confidence." }, { title: "Certifications", desc: "We sponsor your growth via Udemy, Coursera, and cloud certifications." }, { title: "Knowledge Sharing", desc: "Participate in TechTalks, Hackathons, and Community Challenges." }].map(({ title, desc }, idx) => (
              <div key={idx} className="bg-white shadow-md rounded-xl p-4 border hover:shadow-lg transition">
          ...
          <div className="flex flex-wrap gap-4 justify-center mt-10">
            {["Hackathon Winner", "Top Performer", "Team Mentor", "Certified Pro"].map((badge, idx) => (
              <span
                key={idx}
